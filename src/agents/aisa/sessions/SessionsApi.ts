...
export default class SessionsApi extends BaseAPI {
  ...
  public create(): Promise<AgentSessionResponse> {
    return this.restClient.post<AgentSessionResponse>('/agents/aisa/sessions', {}).then((response) => {
  ...
  public delete(sessionId: string, ): Promise<AgentSessionResponse> {
    ...
    return this.restClient.delete<AgentSessionResponse>('/agents/aisa/sessions/{session_id}', pathParamMap).then((response) => {
      return map(response, AgentSessionResponse);
    });
  }
  ...
  public get(sessionId: string, ): Promise<AgentSessionHistoryResponse> {
    ...
    return this.restClient.get<AgentSessionHistoryResponse>('/agents/aisa/sessions/{session_id}', pathParamMap).then((response) => {
  ...
  public list(): Promise<AgentSessionListResponse> {
    return this.restClient.get<AgentSessionListResponse>('/agents/aisa/sessions', {}).then((response) => {
