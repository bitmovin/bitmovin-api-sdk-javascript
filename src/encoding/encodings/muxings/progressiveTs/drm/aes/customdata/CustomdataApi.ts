...
export default class CustomdataApi extends BaseAPI {
  ...
  /**
   * @summary AES encryption Custom Data of Progressive TS muxing
  ...
  public get(encodingId: string, muxingId: string, drmId: string): Promise<CustomData> {
    ...
    return this.restClient.get<CustomData>('/encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/drm/aes/{drm_id}/customData', pathParamMap).then((response) => {
