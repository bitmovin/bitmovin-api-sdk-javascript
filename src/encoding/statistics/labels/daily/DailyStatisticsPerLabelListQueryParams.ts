...
export interface DailyStatisticsPerLabelListQueryParams {
...
export class DailyStatisticsPerLabelListQueryParamsBuilder {
    private internalParams: DailyStatisticsPerLabelListQueryParams = {};
