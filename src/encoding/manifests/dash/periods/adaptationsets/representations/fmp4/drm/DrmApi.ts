...
import DashFmp4DrmRepresentationListQueryParams from './DashFmp4DrmRepresentationListQueryParams';
...
export default class DrmApi extends BaseAPI {
   ...
   * @memberof DrmApi
   */
  public list(manifestId: string, periodId: string, adaptationsetId: string, queryParams?: DashFmp4DrmRepresentationListQueryParams): Promise<PaginationResponse<DashFmp4DrmRepresentation>> {
    const pathParamMap = {
      manifest_id: manifestId,
      period_id: periodId,
      adaptationset_id: adaptationsetId
