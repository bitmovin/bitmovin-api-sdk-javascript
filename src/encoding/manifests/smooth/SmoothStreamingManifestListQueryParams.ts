...
export interface SmoothStreamingManifestListQueryParams {
...
export class SmoothStreamingManifestListQueryParamsBuilder {
    private internalParams: SmoothStreamingManifestListQueryParams = {};
