...
import AzureInputListQueryParams from './AzureInputListQueryParams';
...
export default class AzureApi extends BaseAPI {
   ...
   * @memberof AzureApi
   */
  public list(queryParams?: AzureInputListQueryParams): Promise<PaginationResponse<AzureInput>> {
