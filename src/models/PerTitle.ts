...
import H265V2PerTitleConfiguration from './H265V2PerTitleConfiguration';
...
export class PerTitle {
   ...
   * @memberof PerTitle
   */
  public h265V2Configuration?: H265V2PerTitleConfiguration;
  ...
  constructor(obj?: Partial<PerTitle>) {
    ...
    this.h265V2Configuration = map(obj.h265V2Configuration, H265V2PerTitleConfiguration);
  }
}
