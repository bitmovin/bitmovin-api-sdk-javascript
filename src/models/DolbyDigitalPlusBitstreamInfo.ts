...
import DolbyDigitalPlusSurroundMode from './DolbyDigitalPlusSurroundMode';

/**
 * @export
 * @class DolbyDigitalPlusBitstreamInfo
 */
export class DolbyDigitalPlusBitstreamInfo {
  /**
   ...
   * @memberof DolbyDigitalPlusBitstreamInfo
   */
  public surroundMode?: DolbyDigitalPlusSurroundMode;
   ...
   * @memberof DolbyDigitalPlusBitstreamInfo
   */
  public surroundExMode?: DolbyDigitalPlusSurroundMode;

  constructor(obj?: Partial<DolbyDigitalPlusBitstreamInfo>) {
    if(!obj) {
      return;
    }
...
export default DolbyDigitalPlusBitstreamInfo;
