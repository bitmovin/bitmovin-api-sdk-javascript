...
export * from './ObjectDetectionBoundingBox';
export * from './ObjectDetectionConfiguration';
export * from './ObjectDetectionResult';
export * from './ObjectDetectionTimestampResult';
