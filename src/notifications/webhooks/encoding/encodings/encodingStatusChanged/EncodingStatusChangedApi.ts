...
export default class EncodingStatusChangedApi extends BaseAPI {
  ...
  /**
   * @summary Create 'Encoding Status Changed' Webhook
  ...
  /**
   * @summary Create 'Encoding Status Changed' Webhook for a specific Encoding
  ...
  /**
   * @summary Update 'Encoding Status Changed' Webhook
