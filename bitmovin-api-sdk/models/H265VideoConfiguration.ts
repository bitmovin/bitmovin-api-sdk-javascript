 ...
 */
export default class H265VideoConfiguration extends VideoConfiguration {
  constructor(obj: any) {
    super(obj);
    ...
    this.maxAverageLightLevel = map(obj.maxAverageLightLevel);
   ...
   * @memberof H265VideoConfiguration
   */
  public maxContentLightLevel?: string;
  /**
   ...
   * @memberof H265VideoConfiguration
   */
  public maxAverageLightLevel?: number;
  /**
