...
import HttpsInputListQueryParams from './HttpsInputListQueryParams';
...
export default class HttpsApi extends BaseAPI {
   ...
   * @memberof HttpsApi
   */
  public list(queryParams?: HttpsInputListQueryParams): Promise<PaginationResponse<HttpsInput>> {
