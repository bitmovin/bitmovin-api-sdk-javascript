...
export default class CustomdataApi extends BaseAPI {
  ...
  public getCustomData(encodingId: string, streamId: string, subtitleId: string): Promise<CustomData> {
    ...
    return this.restClient.get<CustomData>('/encoding/encodings/{encoding_id}/streams/{stream_id}/subtitles/dvbsub/{subtitle_id}/customData', pathParamMap).then((response) => {
