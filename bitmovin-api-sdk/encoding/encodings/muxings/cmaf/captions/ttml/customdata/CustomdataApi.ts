...
export default class CustomdataApi extends BaseAPI {
  ...
  public getCustomData(encodingId: string, muxingId: string, captionsId: string): Promise<CustomData> {
    ...
    return this.restClient.get<CustomData>('/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/captions/ttml/{captions_id}/customData', pathParamMap).then((response) => {
