...
export default class WidevineApi extends BaseAPI {
  ...
  /**
   * @summary Add Widevine DRM to CMAF
  ...
  public create(encodingId: string, muxingId: string, widevineDrm?: WidevineDrm): Promise<WidevineDrm> {
    ...
    return this.restClient.post<WidevineDrm>('/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/widevine', pathParamMap, widevineDrm).then((response) => {
      return new WidevineDrm(response);
    });
  }

  /**
   * @summary Delete Widevine DRM from CMAF
   * @param {string} encodingId Id of the encoding.
   * @param {string} muxingId Id of the CMAF muxing
  ...
  public delete(encodingId: string, muxingId: string, drmId: string): Promise<BitmovinResponse> {
    ...
    return this.restClient.delete<BitmovinResponse>('/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/widevine/{drm_id}', pathParamMap).then((response) => {
      return new BitmovinResponse(response);
    });
  }

  /**
   * @summary Widevine DRM Details of CMAF
   * @param {string} encodingId Id of the encoding.
   * @param {string} muxingId Id of the CMAF muxing
   * @param {string} drmId Id of the widevine drm.
   * @throws {RequiredError}
  ...
  public get(encodingId: string, muxingId: string, drmId: string): Promise<WidevineDrm> {
    ...
    return this.restClient.get<WidevineDrm>('/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/widevine/{drm_id}', pathParamMap).then((response) => {
      return new WidevineDrm(response);
    });
  }

  /**
   * @summary List Widevine DRMs of CMAF
   * @param {string} encodingId Id of the encoding.
   * @param {string} muxingId Id of the CMAF muxing
  ...
  public list(encodingId: string, muxingId: string, queryParams?: WidevineDrmListQueryParams): Promise<PaginationResponse<WidevineDrm>> {
    ...
    return this.restClient.get<PaginationResponse<WidevineDrm>>('/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/widevine', pathParamMap, queryParams).then((response) => {
