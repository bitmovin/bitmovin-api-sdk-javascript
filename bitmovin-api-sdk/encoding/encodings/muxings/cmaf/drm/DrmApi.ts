...
export default class DrmApi extends BaseAPI {
  ...
  /**
   * @summary List all DRMs of CMAF Muxing
  ...
  public list(encodingId: string, muxingId: string): Promise<PaginationResponse<Drm>> {
    ...
    return this.restClient.get<PaginationResponse<Drm>>('/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm', pathParamMap).then((response) => {
