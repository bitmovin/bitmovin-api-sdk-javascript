...
export default class CustomdataApi extends BaseAPI {
  ...
  /**
   * @summary PlayReady DRM Custom Data of CMAF
  ...
  public getCustomData(encodingId: string, muxingId: string, drmId: string): Promise<CustomData> {
    ...
    return this.restClient.get<CustomData>('/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/playready/{drm_id}/customData', pathParamMap).then((response) => {
