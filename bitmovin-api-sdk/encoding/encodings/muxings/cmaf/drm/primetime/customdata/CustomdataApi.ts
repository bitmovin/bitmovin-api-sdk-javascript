...
export default class CustomdataApi extends BaseAPI {
  ...
  /**
   * @summary PrimeTime DRM Custom Data of CMAF
  ...
  public getCustomData(encodingId: string, muxingId: string, drmId: string): Promise<CustomData> {
    ...
    return this.restClient.get<CustomData>('/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/primetime/{drm_id}/customData', pathParamMap).then((response) => {
