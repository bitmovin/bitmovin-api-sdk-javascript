...
export default class WebvttApi extends BaseAPI {
  ...
  public create(encodingId: string, muxingId: string, webVttEmbed?: WebVttEmbed): Promise<WebVttEmbed> {
    ...
    return this.restClient.post<WebVttEmbed>('/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/captions/webvtt', pathParamMap, webVttEmbed).then((response) => {
  ...
  public get(encodingId: string, muxingId: string, captionsId: string): Promise<WebVttEmbed> {
    ...
    return this.restClient.get<WebVttEmbed>('/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/captions/webvtt/{captions_id}', pathParamMap).then((response) => {
      return new WebVttEmbed(response);
    });
  }
  ...
  public list(encodingId: string, muxingId: string): Promise<PaginationResponse<WebVttEmbed>> {
    ...
    return this.restClient.get<PaginationResponse<WebVttEmbed>>('/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/captions/webvtt', pathParamMap).then((response) => {
