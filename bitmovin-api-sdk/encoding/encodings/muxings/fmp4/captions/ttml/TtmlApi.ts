...
export default class TtmlApi extends BaseAPI {
  ...
  public create(encodingId: string, muxingId: string, ttmlEmbed?: TtmlEmbed): Promise<TtmlEmbed> {
    ...
    return this.restClient.post<TtmlEmbed>('/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/captions/ttml', pathParamMap, ttmlEmbed).then((response) => {
  ...
  public delete(encodingId: string, muxingId: string, captionsId: string): Promise<TtmlEmbed> {
    ...
    return this.restClient.delete<TtmlEmbed>('/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/captions/ttml/{captions_id}', pathParamMap).then((response) => {
      return new TtmlEmbed(response);
    });
  }
  ...
  public get(encodingId: string, muxingId: string, captionsId: string): Promise<TtmlEmbed> {
    ...
    return this.restClient.get<TtmlEmbed>('/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/captions/ttml/{captions_id}', pathParamMap).then((response) => {
      return new TtmlEmbed(response);
    });
  }
  ...
  public list(encodingId: string, muxingId: string, queryParams?: TtmlEmbedListQueryParams): Promise<PaginationResponse<TtmlEmbed>> {
    ...
    return this.restClient.get<PaginationResponse<TtmlEmbed>>('/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/captions/ttml', pathParamMap, queryParams).then((response) => {
