...
export default class TtmlApi extends BaseAPI {
  ...
  public create(encodingId: string, ttmlExtract?: TtmlExtract): Promise<TtmlExtract> {
    ...
    return this.restClient.post<TtmlExtract>('/encoding/encodings/{encoding_id}/captions/ttml', pathParamMap, ttmlExtract).then((response) => {
  ...
  public delete(encodingId: string, captionsId: string): Promise<TtmlExtract> {
    ...
    return this.restClient.delete<TtmlExtract>('/encoding/encodings/{encoding_id}/captions/ttml/{captions_id}', pathParamMap).then((response) => {
      return new TtmlExtract(response);
    });
  }
  ...
  public get(encodingId: string, captionsId: string): Promise<TtmlExtract> {
    ...
    return this.restClient.get<TtmlExtract>('/encoding/encodings/{encoding_id}/captions/ttml/{captions_id}', pathParamMap).then((response) => {
      return new TtmlExtract(response);
    });
  }
  ...
  public list(encodingId: string, queryParams?: TtmlExtractListQueryParams): Promise<PaginationResponse<TtmlExtract>> {
    ...
    return this.restClient.get<PaginationResponse<TtmlExtract>>('/encoding/encodings/{encoding_id}/captions/ttml', pathParamMap, queryParams).then((response) => {
