...
export default class WebvttApi extends BaseAPI {
  ...
  public create(encodingId: string, webVttExtract?: WebVttExtract): Promise<WebVttExtract> {
    ...
    return this.restClient.post<WebVttExtract>('/encoding/encodings/{encoding_id}/captions/extract/webvtt', pathParamMap, webVttExtract).then((response) => {
  ...
  public delete(encodingId: string, captionsId: string): Promise<WebVttExtract> {
    ...
    return this.restClient.delete<WebVttExtract>('/encoding/encodings/{encoding_id}/captions/extract/webvtt/{captions_id}', pathParamMap).then((response) => {
      return new WebVttExtract(response);
    });
  }
  ...
  public get(encodingId: string, captionsId: string): Promise<WebVttExtract> {
    ...
    return this.restClient.get<WebVttExtract>('/encoding/encodings/{encoding_id}/captions/extract/webvtt/{captions_id}', pathParamMap).then((response) => {
      return new WebVttExtract(response);
    });
  }
  ...
  public list(encodingId: string, queryParams?: WebVttExtractListQueryParams): Promise<PaginationResponse<WebVttExtract>> {
    ...
    return this.restClient.get<PaginationResponse<WebVttExtract>>('/encoding/encodings/{encoding_id}/captions/extract/webvtt', pathParamMap, queryParams).then((response) => {
