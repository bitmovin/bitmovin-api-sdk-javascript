...
export default class CeaApi extends BaseAPI {
  ...
  public create(encodingId: string, captionsCea?: CaptionsCea): Promise<CaptionsCea> {
    ...
    return this.restClient.post<CaptionsCea>('/encoding/encodings/{encoding_id}/captions/extract/cea', pathParamMap, captionsCea).then((response) => {
  ...
  public delete(encodingId: string, captionsId: string): Promise<CaptionsCea> {
    ...
    return this.restClient.delete<CaptionsCea>('/encoding/encodings/{encoding_id}/captions/extract/cea/{captions_id}', pathParamMap).then((response) => {
      return new CaptionsCea(response);
    });
  }
  ...
  public get(encodingId: string, captionsId: string): Promise<CaptionsCea> {
    ...
    return this.restClient.get<CaptionsCea>('/encoding/encodings/{encoding_id}/captions/extract/cea/{captions_id}', pathParamMap).then((response) => {
      return new CaptionsCea(response);
    });
  }
  ...
  public list(encodingId: string, queryParams?: CaptionsCeaListQueryParams): Promise<PaginationResponse<CaptionsCea>> {
    ...
    return this.restClient.get<PaginationResponse<CaptionsCea>>('/encoding/encodings/{encoding_id}/captions/extract/cea', pathParamMap, queryParams).then((response) => {
